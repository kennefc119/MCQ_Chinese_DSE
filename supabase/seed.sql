...
-- p03 逍遙遊
('q-p03-1','p03','莊子以「不龜手之藥」的故事回應惠子，主要想說明甚麼道理？','原文云「能不龜手一也；或以封，或不免於洴澼絖，則所用之異也」，說明同一藥方，宋人世代用於漂洗綿絮，不過得數金；客人卻以之助吳國水戰獲勝，裂地封賞。可見同一事物因使用方法不同，效果截然不同，批評惠子「拙於用大」。',3,'seed',true),
('q-p03-2','p03','莊子建議把大樗「樹之於無何有之鄉，廣莫之野」，這主要反映他怎樣的人生追求？','原文云「彷徨乎無為其側，逍遙乎寢臥其下；不夭斤斧，物無害者。無所可用，安所困苦哉？」可見「無何有之鄉」並非指消極避世或歸隱，而是象徵超越世俗功利標準的精神空間，反映莊子追求擺脫「有用」與「無用」的枷鎖，達致心靈逍遙自在的境界。',3,'seed',true),
('q-p03-3','p03','莊子批評惠子「猶有蓬之心也夫」，「蓬之心」在文中意指甚麼？','蓬草中空而彎曲，喻心竅不通。原文中莊子反問惠子「何不慮以為大樽而浮乎江湖」，指惠子只看到大瓠盛水不堅、為瓢太淺，卻想不到把大瓠作為腰舟浮游江湖，可見惠子心思閉塞、不善通變，故以「蓬之心」斥之。',3,'seed',true),
('q-p03-4','p03','莊子以「樗樹」的故事闡述「無用之用」，下列哪項最能體現此道理？','原文云樗樹「不夭斤斧，物無害者」，即因世俗標準認為其「無用」而免於被砍伐，反而得以保全自身。莊子藉此說明世俗追求的「有用」往往招致禍害（如狸狌因機巧而「中於機辟，死於罔罟」），而「無用」反能讓事物保全性命，方為「大用」。',4,'seed',true),
-- p04 勸學
...
-- q-p03-1
('q-p03-1-a','q-p03-1','A','宋人目光短淺，未能善用祖傳秘方',false),
('q-p03-1-b','q-p03-1','B','同一事物因使用方法不同，效果截然不同',true),
('q-p03-1-c','q-p03-1','C','善於游說者方能建功立業獲封賞',false),
('q-p03-1-d','q-p03-1','D','世人應以實際功效衡量事物價值',false),
-- q-p03-2
('q-p03-2-a','q-p03-2','A','遠離塵世，隱居山林以避禍患',false),
('q-p03-2-b','q-p03-2','B','超越世俗價值，追求精神自由',true),
('q-p03-2-c','q-p03-2','C','不問世事，消極避世以求安穩',false),
('q-p03-2-d','q-p03-2','D','回歸自然，效法天地萬物運行',false),
-- q-p03-3
('q-p03-3-a','q-p03-3','A','心胸廣闊，不拘泥於小節',false),
('q-p03-3-b','q-p03-3','B','思想飄忽不定，缺乏主見',false),
('q-p03-3-c','q-p03-3','C','心思閉塞，不善於變通',true),
('q-p03-3-d','q-p03-3','D','內心堅定，不為外物所動',false),
-- q-p03-4
('q-p03-4-a','q-p03-4','A','才能出眾者必為世所重用',false),
('q-p03-4-b','q-p03-4','B','世俗認為無用者反能保全自身',true),
('q-p03-4-c','q-p03-4','C','同一事物因用法不同價值各異',false),
('q-p03-4-d','q-p03-4','D','不合世俗標準者難免遭眾人拋棄',false),
-- q-p04-1
